   ...
   <div className="mx-auto px-14">
      <div className="hidden sm:mb-8 sm:flex ">
        <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
           Welcome to my portfolio. <a href="/aboutme" className="font-semibold text-indigo-600">
      ...
      <div className="">
        ...
        <div className="mt-10 flex items-center pb-32 gap-x-6">
          <a href="/Cv.pdf" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Check out my resume</a>

          {/* <a href="#" className="text-sm/6 font-semibold text-gray-900 ">Learn more <span aria-hidden="true">→</span></a> */}
          <a href="/ContactSection" className="text-sm/6 font-semibold text-gray-900 ">Get in touch <span aria-hidden="true">→</span></a>
