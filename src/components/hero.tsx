...
<div className="relative isolate px-6 pt-14 lg:px-8 ">
   <div className="mx-auto px-14">
      ...
      <div className="">
        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">BOUMAZIAN FADOUA</h1>
        ...
        <div className="mt-10 flex items-center pb-44 gap-x-6">
