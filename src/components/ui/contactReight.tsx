  ...
  return (
    <form className="space-y-4">
      ...
      <div className="sm:col-span-2">
        ...
        <div className="mt-2.5">
          <textarea id="message"  placeholder="Tell me about your project ..." name="message"  className="block w-full rounded-md bg-white px-3.5 py-4 text-base text-gray-900 outline-1 -outline-offset-1
           outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"></textarea>
        </div>
      </div>
    
    <div className="mt-10">
      <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 
