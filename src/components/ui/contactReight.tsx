...
export default function ContactReight() {
  ...
  return (
    <>
      ...
      <div className={`cr ${t}`}>
        <div className="cr-t">Send a Message</div>
        {/* استعملي Formspree هنا */}
        <form className="cr-form" action="https://formspree.io/f/xdawpgga" method="POST">
          <div className="cr-row">
            <div className="cr-f">
              <label className="cr-l">Your Name</label>
              <input className="cr-i" type="text" name="name" required placeholder="Karmin Locia"/>
            </div>
            <div className="cr-f">
              <label className="cr-l">Your Email</label>
              <input className="cr-i" type="email" name="email" required placeholder="karmin@gmail.com"/>
            </div>
          </div>
          <div className="cr-f">
          ...
          <div className="cr-f">
            ...
            <textarea className="cr-ta" name="message" required placeholder="Tell me about your project..."/>
          </div>
          <button type="submit" className="cr-btn">Let&apos;s Talk ✦</button>
        </form>
      </div>
